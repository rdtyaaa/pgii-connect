            ...
            <div class="overflow-y-auto px-16 py-8 text-gray-900">
                ...
                <div class="mb-6 grid gap-6 md:grid-cols-2">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="status" name="status"
                            ...
                            @elseif(strtolower($scheduledInterview->status) === 'disetujui') bg-green-300
                ...
                @if ($scheduledInterview)
                    <div id="alert-1"
                        ...
                        <p class="ml-1">
                            {{ $scheduledInterview->scheduled_at->translatedFormat('l, d-m-Y') }}. Silahkan datang ke sekolah.
                        </p>
                    </div>
                    <p class="text-sm text-gray-700">
                        Jika ada kendala, silahkan hubungi admin melalui email <a href="mailto:admin@sekolah.com"
                            class="text-blue-600 hover:underline">admin@sekolah.com</a>
                        atau telepon <a href="tel:+6281234567890"
                            class="text-blue-600 hover:underline">0812-3456-7890</a>.
                    </p>
                @else
