            ...
            <div class="ms-4 w-full overflow-x-auto rounded-lg border shadow">
                <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Email</td>
                            <td class="px-6 py-4">{{ $interview->student->email }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Scheduled At</td>
        ...
        @if ($interview->student->detailStudent)
            <div class="relative mt-8 overflow-x-auto rounded-lg border shadow">
                <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
                    ...
                    <tbody>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Nickname:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->nickname }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Birthplace and Date:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->birth_place }},
                                {{ $interview->student->detailStudent->birth_date }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Religion:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->religion }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Nationality:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->nationality }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">School Origin:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->school_origin }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">NISN:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->nisn }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">NIS:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->nis }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Ijazah Number:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->ijazah_number }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">SKHUN Number:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->skhun_number }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Exam Number:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->exam_number }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">NIK:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->nik }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Siblings Count:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->siblings_count }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Child Position:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->child_position }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Language:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->language }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Special Needs:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->special_needs }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Address:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->address }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Transport:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->transport }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Living With:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->living_with }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Home Phone:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->home_phone }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">KPS Number:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->kps_number }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Height:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->height }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Weight:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->weight }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Blood Type:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->blood_type }}</td>
                        </tr>
                        <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Distance to School:</td>
                            <td class="px-6 py-4">{{ $interview->student->detailStudent->distance_to_school }}</td>
                        </tr>
                        <tr class="bg-white dark:bg-gray-800">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Travel Time:</td>
                ...
                <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
                    ...
                    <tbody>
                        @foreach ($interview->student->documents as $document)
                            <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">{{ $document->type }}
                                </td>
                                <td class="px-6 py-4">
                                    <a href="{{ asset('storage/' . $document->path) }}"
                                        class="text-blue-600 dark:text-blue-400" target="_blank">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
