...
<body class="flex min-h-screen items-center justify-center bg-gray-100">
    <div class="flex h-screen w-screen flex-col items-center justify-center gap-12 py-8">
        <svg class="aspect-video" height='50vh' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
